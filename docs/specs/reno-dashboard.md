...
- **AC-8**: Blocked complaints, work orders and RKB rows render as blocked with their citation reachable in one click, and their clock displayed as paused rather than counting down. Asserted per entity type.
